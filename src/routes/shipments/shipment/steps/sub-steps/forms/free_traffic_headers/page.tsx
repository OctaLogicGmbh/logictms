...
import { ShipmentSubStepFreeTrafficHeaders } from '@/models/shipments/substeps';
...
const useSubStepData = () => {
  return useLoaderData() as ShipmentSubStepFreeTrafficHeaders;
};

const SubStepFreeTrafficHeadersPage = () => {
...
export default SubStepFreeTrafficHeadersPage;
