...
import { ShipmentSubStepFreeTrafficReceiver } from '@/models/shipments/substeps';
...
const useSubStepData = () => {
  return useLoaderData() as ShipmentSubStepFreeTrafficReceiver;
};

const SubStepFreeTrafficReceiverPage = () => {
...
export default SubStepFreeTrafficReceiverPage;
