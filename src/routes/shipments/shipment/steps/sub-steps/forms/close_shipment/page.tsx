...
import { ShipmentSubStepCloseShipment } from '@/models/shipments/substeps';
...
const useSubStepData = () => {
  return useLoaderData() as ShipmentSubStepCloseShipment;
};

const SubStepCloseShipmentPage = () => {
...
export default SubStepCloseShipmentPage;
