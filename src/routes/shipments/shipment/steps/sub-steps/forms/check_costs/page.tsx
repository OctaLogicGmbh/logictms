...
import { ShipmentSubStepCheckCosts } from '@/models/shipments/substeps';
...
const useSubStepData = () => {
  return useLoaderData() as ShipmentSubStepCheckCosts;
};

const SubStepCheckCostsPage = () => {
...
export default SubStepCheckCostsPage;
