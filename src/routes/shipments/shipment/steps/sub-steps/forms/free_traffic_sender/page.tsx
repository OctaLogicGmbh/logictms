...
import { ShipmentSubStepFreeTrafficSender } from '@/models/shipments/substeps';
...
const useSubStepData = () => {
  return useLoaderData() as ShipmentSubStepFreeTrafficSender;
};

const SubStepFreeTrafficSenderPage = () => {
...
export default SubStepFreeTrafficSenderPage;
